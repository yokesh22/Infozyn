...
class _UserPanelState extends State<UserPanel> {
  ...
  postlike(postid,uid,isliked)async{
    final res = await database.updatelike(currentUserid!, postid,isliked);
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            postlike(snapshot.data!.docs[index]['eventname'], currentUserid,postLiked);
                          },
                          child: Expanded(
                              child: Column(
                            children: [
                                ...
                                child: Row(
                                  children: [
                                    Icon(
                                      Icons.thumb_up_alt,
                                      color:
                                          postLiked ? Colors.blue : Colors.grey,
                                      size: 30,
                                    ),
                                    SizedBox(
                                      width: 5.0,
                                    ...
                                    Text(
                                      '${postLiked ? snapshot.data!.docs[index]['likes'] + 1 : snapshot.data!.docs[index]['likes']}',
                                      style: TextStyle(
                                          fontSize: 17,
                                          color: postLiked
                                              ? Colors.black
